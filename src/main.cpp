...
int main()
{
	...
	// 4 -    	2 103 487
	// 5	-    89 941 194
	// boardParser.fillBoard("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8"); // Pos 5 - 1 passed
	// boardParser.fillBoard("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10"); // Pos 6 - 4 passed (5 is 164 075 514 instead of 164 075 551)
